...
namespace StrategyRPG.TileEngine.Sprite
{
    /// <summary>
    ...
    /// <summary>
    /// Extension methods over a Sprite.
    /// </summary>
    public static class SpriteExtensionMethods
    {
        ...
        public static SpriteAnimation ToSprite(this Texture2D spriteSheet)
        {
            SpriteAnimation sprite = new SpriteAnimation(spriteSheet);

            sprite.AddAnimation("WalkEast", 0, 48 * 0, 48, 48, 8, 0.1f);
            sprite.AddAnimation("WalkNorth", 0, 48 * 1, 48, 48, 8, 0.1f);
            sprite.AddAnimation("WalkNorthEast", 0, 48 * 2, 48, 48, 8, 0.1f);
            sprite.AddAnimation("WalkNorthWest", 0, 48 * 3, 48, 48, 8, 0.1f);
            sprite.AddAnimation("WalkSouth", 0, 48 * 4, 48, 48, 8, 0.1f);
            sprite.AddAnimation("WalkSouthEast", 0, 48 * 5, 48, 48, 8, 0.1f);
            sprite.AddAnimation("WalkSouthWest", 0, 48 * 6, 48, 48, 8, 0.1f);
            sprite.AddAnimation("WalkWest", 0, 48 * 7, 48, 48, 8, 0.1f);

            sprite.AddAnimation("IdleEast", 0, 48 * 0, 48, 48, 1, 0.2f);
            sprite.AddAnimation("IdleNorth", 0, 48 * 1, 48, 48, 1, 0.2f);
            sprite.AddAnimation("IdleNorthEast", 0, 48 * 2, 48, 48, 1, 0.2f);
            sprite.AddAnimation("IdleNorthWest", 0, 48 * 3, 48, 48, 1, 0.2f);
            sprite.AddAnimation("IdleSouth", 0, 48 * 4, 48, 48, 1, 0.2f);
            sprite.AddAnimation("IdleSouthEast", 0, 48 * 5, 48, 48, 1, 0.2f);
            sprite.AddAnimation("IdleSouthWest", 0, 48 * 6, 48, 48, 1, 0.2f);
            sprite.AddAnimation("IdleWest", 0, 48 * 7, 48, 48, 1, 0.2f);

            sprite.Position = new Vector2(100, 100);
            sprite.DrawOffset = new Vector2(-24, -38);
            sprite.CurrentAnimation = "WalkEast";
